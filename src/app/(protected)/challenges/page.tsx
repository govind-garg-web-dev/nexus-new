...
export default async function ChallengesPage() {
  ...
  return (
    <div className="p-6 lg:p-10 max-w-6xl mx-auto">
      <div className="mb-10">
        <p className="font-pixel text-[11px] tracking-[0.25em] text-[#5a5a7a] mb-2">SKILL VERIFICATION</p>
        ...
        <p className="font-tech text-xs text-[#5a5a7a]">
          Badges expire after 18 months. Re-challenge to renew. Skills go stale — so do claims.
        </p>
      </div>
