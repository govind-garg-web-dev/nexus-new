...
const PROTECTED_ROUTES = ["/dashboard", "/profile", "/feed", "/chat", "/challenges", "/co-founder", "/vault", "/study-rooms", "/consulting", "/events", "/referrals", "/carpool", "/roommates", "/confessions", "/marketplace", "/circles", "/societies", "/daily", "/leaderboard", "/mod", "/admin"];
